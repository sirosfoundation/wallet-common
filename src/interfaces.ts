...
export interface VerifyingEngineI {
	...
	verify({ rawCredential, opts }: { rawCredential: unknown, opts: { expectedNonce?: string, expectedAudience?: string, holderNonce?: string, responseUri?: string, verifierEncryptionJwk?: JWK } }): Promise<CustomResult<{ holderPublicKey: JWK; }, CredentialVerificationError>>;
}
...
export interface CredentialVerifier {
	verify(args: { rawCredential: unknown, opts: { expectedNonce?: string, expectedAudience?: string, holderNonce?: string, responseUri?: string, verifierEncryptionJwk?: JWK } }): Promise<CustomResult<{
		holderPublicKey: JWK,
